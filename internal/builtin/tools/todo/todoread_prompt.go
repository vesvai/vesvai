...
func todoreadToolPromptBuilder() *prompt.Prompt {
	return prompt.New().
		...
		List("At the beginning of conversations to see what's pending",
		...
		Paragraph("Usage:").
		List("This tool takes in no parameters. So leave the input blank or empty. DO NOT include a dummy object, placeholder string or a key like 'input' or 'empty'. LEAVE IT BLANK.",
